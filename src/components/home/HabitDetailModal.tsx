...
export const HabitDetailModal: React.FC<HabitDetailModalProps> = ({
  ...
  return (
    <View>
        ...
        <View className="flex-row justify-between items-center bg-zinc-800/40 p-3 rounded-xl border border-white/5">
          <View className="items-center flex-1">
            ...
            {log.habit_delta ? (
              <Text
                ...
                style={{ color: isPositiveHabit ? theme.success : theme.error }}
              >
          ...
          <View className="items-center flex-1">
            ...
            <View className="flex-row items-center gap-1 mt-1">
              <FontAwesome5 name="shield-alt" size={11} color={theme.primary} />
      ...
      <View><Text className="text-text-base">Ngày nghỉ em ây</Text></View>
      : (log.habit_delta &&log.habit_delta<0)?
      <View><Text className="text-text-base">Quá đà em ây</Text></View>:null}
    </View>
  );
};
